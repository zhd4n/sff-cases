...
{{--                <h4 class="ui header">Upload photos</h4>--}}
{{--                <div class="field">--}}
{{--                    <label for="upload-images" class="ui icon button">--}}
{{--                        <i class="file icon"></i>--}}
{{--                        Choose files--}}
{{--                    </label>--}}
{{--                    <input type="file" id="upload-images" name="images[]" multiple="multiple" accept="image/png, image/jpeg, image/gif" class="ui file input">--}}
{{--                </div>--}}

{{--                <div id="preview-images" class="ui cards"></div>--}}

{{--            </div>--}}

{{--            @isset($case)--}}
{{--                <div class="ui secondary basic segment">--}}
{{--                    <div class="ui header">Photos</div>--}}
{{--                    <div class="ui cards">--}}
{{--                        @foreach ($case->getMedia('gallery') as $photo)--}}
{{--                            <div id="photo-{{ $photo->id }}" class="ui card">--}}
{{--                                <div class="image">--}}
{{--                                    <img class="image" src="{{ $photo->getUrl() }}">--}}
{{--                                </div>--}}
{{--                                <div class="extra content">--}}
{{--                                    <a href="{{ route('cases.media.delete', ['case_part' => $case, 'media' => $photo]) }}"--}}
{{--                                       data-delete="photo-{{ $photo->id }}"--}}
{{--                                       class="ui ajax-delete fluid bottom button">--}}
